...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.booking.fields.customer")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.customer) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.booking.fields.phone_number")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.phone_number) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.booking.fields.booking_day")) + "\n                      ")]), _vm._v(" "), _c("td", [_vm._v("\n                        " + _vm._s(_vm.entry.booking_day) + "\n                      ")])]), _vm._v(" "), _c("tr", [_c("td", {
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.booking.fields.slect_room")) + "\n                      ")]), _vm._v(" "), _c("td", [_c("datatable-list", {
    attrs: {
      row: _vm.entry,
    ...
    staticClass: "text-primary"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("cruds.booking.fields.select_service")) + "\n                      ")]), _vm._v(" "), _c("td", [_c("datatable-list", {
    attrs: {
      row: _vm.entry,
