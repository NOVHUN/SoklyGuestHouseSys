        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: 'table_view',
              path: { name: 'room_maintenances.index' },
